...
const Address = () => {
  ...
  return (
      ...
      <div className="flex flex-col w-[400px] justify-between gap-y-3">
        <div className='flex items-start flex-col mx-auto w-80'>
                        <div className='font-semibold text-2xl uppercase text-black'>Add <span className='text-gray-600 border-b-2 border-black'>Address</span></div>
                </div> 
