...
export const register = async(req,res)=>{
    try {
        ...
        res.cookie('token', token, {httpOnly:true, secure:'production',  sameSite:'production'?'none':'strict', maxAge:1*24*60*60*1000})

        res.json({success:true, message:'Account Successfully Created', token})
